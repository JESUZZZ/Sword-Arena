...
public class PlayerControl2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (Input.GetAxisRaw("JoyStick_Horizontal2") != 0 || Input.GetAxisRaw("JoyStick_Vertical2") != 0)
            {
                x_move = Input.GetAxisRaw("JoyStick_Horizontal2");
                y_move = Input.GetAxisRaw("JoyStick_Vertical2");
            ...
            {
                x_move = Input.GetAxisRaw("Horizontal2");
                y_move = Input.GetAxisRaw("Vertical2");
            }
        ...
        if ((Input.GetKeyDown(KeyCode.Keypad1) || Input.GetButton("JoyStick_A2")) && canDash && !isStun && (x_move != 0 || y_move != 0) && !whileDash && !isLowSpeedParry && !whileAttack && !isKnockBack && !whileSK1 && !whileSK2)
        {
            dashCount++;
        ...
        if ((Input.GetKeyDown(KeyCode.Keypad2) || Input.GetButton("JoyStick_X2")) && canAttack && !isStun && !whileDash && !isLowSpeedParry && !isKnockBack && !whileSK1 && !whileSK2)
        {
            whileAttack = true;
            canAttack = false;
            canMove = false;
        ...
        else if ((Input.GetKeyDown(KeyCode.Keypad2) || Input.GetButton("JoyStick_X2")) && canAttack && !isStun && !whileDash && !isLowSpeedParry && !isKnockBack && !whileSK1 && whileSK2 && (character == 4 || character == 7))
        {
            whileAttack = true;
            canAttack = false;
            canMove = false;
        ...
        if ((Input.GetKeyDown(KeyCode.Keypad3) || Input.GetButton("JoyStick_Y2")) && canParry && !isStun && !whileDash && !whileAttack && !isKnockBack && !whileSK1 && !whileSK2)
        {
            parryCount++;
            parryCheck++;
        ...
        if (whileParry && PlayerControl.isStun)
        {
            whileParry = false;
        ...
        if (character == 1)
        {
            if ((Input.GetKeyDown(KeyCode.Keypad5) || Input.GetButton("JoyStick_LB2")) && !whileAttack && !whileDash && !isLowSpeedParry && !isKnockBack && !isStun && canSK1)
            {
                whileSK1 = true;
                sk1_count++;
                canSK1 = false;
            ...
            if ((Input.GetKeyDown(KeyCode.Keypad6) || Input.GetButton("JoyStick_RB2")) && !whileAttack && !whileDash && !isLowSpeedParry && !isKnockBack && !isStun && canSK2)
            {
                sk2_count++;
                canSK2 = false;
                canSK1 = true;
        ...
        {
            //float blink;
            if ((Input.GetKeyDown(KeyCode.Keypad5) || Input.GetButton("JoyStick_LB2")) && !whileAttack && !whileDash && !isLowSpeedParry && !isKnockBack && !isStun && canSK1 && !whileSK2 && (x_move != 0 || y_move != 0))
            {
                canMove = false;
                canSK1 = false;
                whileSK1 = true;
            ...
            if ((Input.GetKeyDown(KeyCode.Keypad6) || Input.GetButton("JoyStick_RB2")) && !whileAttack && !whileDash && !isLowSpeedParry && !isKnockBack && !isStun && canSK2 && !whileSK1)
            {
                whileSK2 = true;
                canSK2 = false;
                canMove = false;
        ...
        {
            if ((Input.GetKeyDown(KeyCode.Keypad5) || Input.GetButton("JoyStick_LB2")) && !whileAttack && !whileDash && !isLowSpeedParry && !isKnockBack && !isStun && canSK1 && !whileSK2)
            {
                canSK1 = false;
        ...
        if ((AtkHB2.isCounter || (Char03Trap.playerNum == 1 && Char03Trap.stun) || (Char06StunBall.isStun && Char06StunBall.playerNum == 1)) && oneTimeStun < 1)
        {
            oneTimeStun++;
            stunCount++;
        ...
        {
            oneTimeKnockBack++;
            x_knockBack = PlayerControl.x_lastMove;
            y_knockBack = PlayerControl.y_lastMove;
        }

        if (isKnockBack && LevelControl.p2HP > 0)
        {
            star.SetActive(false);
            ...
            oneTimeStun = 0;
            whileDash = false;
            if ((PlayerControl.x_lastMove < -0.5f && PlayerControl.y_lastMove > 0.5f) || (PlayerControl.x_lastMove < -0.5f && PlayerControl.y_lastMove < -0.5f) || (PlayerControl.y_lastMove < -0.5f && PlayerControl.x_lastMove > 0.5f) || (PlayerControl.x_lastMove > 0.5f && PlayerControl.y_lastMove > 0.5f))
            {
        ...
        else if (isImmortal && oneTimeBlink < 1 && LevelControl.p2HP > 0)
        {
            oneTimeBlink++;
        ...
        if ((LevelControl.p1HP <= 0 || LevelControl.p2HP <= 0) && oneTime < 1)
        {
            ...
            if (LevelControl.p1HP <= 0 && LevelControl.p2HP > 0 && !LevelControl.winByBoom && whileAttack)
            {
            ...
            else if (LevelControl.p2HP <= 0 && LevelControl.p1HP > 0)
            {
                col.enabled = false;
                canMove = false;
            }
    ...
    private void FixedUpdate()
    {
        ...
        if (((x_move < -0.5f && y_move > 0.5f) || (x_move < -0.5f && y_move < -0.5f) || (y_move < -0.5f && x_move > 0.5f) || (x_move > 0.5f && y_move > 0.5f)) && (Input.GetAxisRaw("JoyStick_Horizontal2") == 0 || Input.GetAxisRaw("JoyStick_Vertical2") == 0))
        {
            rb.velocity = new Vector2(rb.velocity.x / 1.5f, rb.velocity.y / 1.5f);
        }
        if ((Input.GetKeyDown(KeyCode.Keypad1) || Input.GetButton("JoyStick_A2")) && canDash && !isStun && (x_move != 0 || y_move != 0) && !whileDash && !isLowSpeedParry && !whileAttack && !isKnockBack && !whileSK1 && !whileSK2)
    ...
    {
        int hp = LevelControl.p2HP;
        yield return new WaitForSeconds(delay);
        if (hp == LevelControl.p2HP)
        {
    ...
    IEnumerator returnPlaceTrap()
    {
        ...
        if (p2HP == LevelControl.p2HP && !isStun && !whileAttack && !whileDash && !isKnockBack && !whileSK2)
        {
            anim.SetBool("isPlaceTrap", false);
            whileSK1 = false;
            canMove = true;
